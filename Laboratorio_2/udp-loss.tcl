...
set tracefile [open udp-loss.tr w]
$ns trace-all $tracefile

# Configuração do arquivo de animação (opcional)
set namfile [open udp-loss.nam w]
...
# Inserir modelo de erro no link n3-n4
set loss_module [new ErrorModel]
$loss_module unit pkt
$loss_module set rate_ 0.1  ;# 10% de perda de pacotes
